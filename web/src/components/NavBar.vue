				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<router-link :class="route_name === 'pk_index' ? 'nav-link active' : 'nav-link'"
							aria-current="page" :to="{ name: 'pk_index' }">对战
						</router-link>
					</li>
					<li class="nav-item">
				...
				<ul class="navbar-nav " v-if="$store.state.user.is_login">
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li>
								<router-link class="dropdown-item" :to="{ name: 'user_account_info' }">个人信息
								</router-link>
							</li>
							<li>
							...
							<li>
								<router-link @click="logout" class="dropdown-item" :to="{ name: 'user_account_login' }">
									退出</router-link>
							</li>
						</ul>
					</li>
